...
export const DownloadScreen = () => {
  return (
    <div className="bg-[#9ACBD0]  m-6 py-24 px-8 rounded-2xl flex flex-col items-center justify-center gap-3">
      ...
      <div className=" flex w-full items-center justify-center gap-4 text-[#fff]">
